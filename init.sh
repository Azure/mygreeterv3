...
# For the api.
cd api
go mod init go.goms.io/aks/rp/mygreeterv3/api
go mod edit -require github.com/Azure/aks-middleware@v0.0.21
cd ..
cd api
cd v1 
...
# For the server
cd server
go mod init go.goms.io/aks/rp/mygreeterv3/server
go mod edit -require go.goms.io/aks/rp/mygreeterv3/api@v0.0.83
go mod edit -require github.com/Azure/aks-middleware@v0.0.21
go mod tidy
cd ..
